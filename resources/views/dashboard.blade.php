...
-->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_4">Meeting</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_5">Time Tracking</a>
                        </li>
        ...
        <main>
            ...
            <!-- <section class="about section-padding" id="Attendence">
                <div class="container">
                    <div class="row">
